...
internal object LabelAnchors {
     ...
     * Нули в «100» распознаватель на мелком шрифте отдаёт буквой «о»,
     * а «мл» — как «мп»: «ккал/1о0 мп». Не узнав такое, разбор брал «1»
     * за калории. Маска терпит обе подмены.
     * Написания единиц — нормализованные: латинское «ml» после нормализации
     * это «мl», а не «ml».
     */
    private val PER_100 = Regex("""(?:на\s*)?1[0о]{2}\s*(?:г|g|м[лпl])""")
