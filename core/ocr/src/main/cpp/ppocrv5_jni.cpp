...
Java_n7_kcalai_ocr_OcrEngine_nativeSetCacheDir(
        JNIEnv *env,
        jclass clazz,
        jstring cache_dir) {
...
JNIEXPORT void JNICALL
Java_n7_kcalai_ocr_OcrEngine_nativeShutdown(
        JNIEnv *env,
        jclass clazz) {
...
Java_n7_kcalai_ocr_OcrEngine_nativeCreate(
        JNIEnv *env,
        jobject thiz,
...
Java_n7_kcalai_ocr_OcrEngine_nativeProcess(
        JNIEnv *env,
        jobject thiz,
        jlong handle,
        jobject bitmap) {
    ...
    jclass ocr_result_class = env->FindClass("n7/kcalai/ocr/OcrResult");
...
JNIEXPORT void JNICALL
Java_n7_kcalai_ocr_OcrEngine_nativeDestroy(
        JNIEnv *env,
        jobject thiz,
        jlong handle) {
...
Java_n7_kcalai_ocr_OcrEngine_nativeGetBenchmark(
        JNIEnv *env,
        jobject thiz,
        jlong handle) {
...
Java_n7_kcalai_ocr_OcrEngine_nativeGetActiveAccelerator(
        JNIEnv *env,
        jobject thiz,
        jlong handle) {
