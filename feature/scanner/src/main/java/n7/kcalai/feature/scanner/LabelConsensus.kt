...
internal class LabelConsensus(
    ...
    private companion object {
        /**
         * Окно в дюжину кадров.
         *
         * Кадр с распознаванием идёт полторы-две десятых секунды, так что дюжина —
         * это пара секунд съёмки. Больше держать незачем: за это время человек
         * успевает перевести камеру, и хвост окна начинает говорить о другой пачке.
         */
        const val WINDOW = 12
